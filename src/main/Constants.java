...
public class Constants {
    ...
    public static final int TailSegmentOffset=2;
    ...
    public static final float BaseDigestionAmount=25;
    public static final float StomachSizeMax=100;
    public static final float StomachSizeMin=25;
    ...
    public static final float HealthMax=10;
    public static final float HealthMin=1;


    public static final float EnergyStorageMax=20;
    public static final float EnergyStorageMin=1;

    public static final float LifeSpanMax=100;
    public static final float LifeSpanMin=10;
