...
public class InputID {
    ...
    public final static int InputCreatureY=1;
    public final static int InputCreatureTarget=2;
    public final static int InputCreatureAngleToTarget=3;
    public final static int InputCreatureDistanceToTarget=4;
    public final static int InputCreaturePreviousDistanceToTarget=5;
    public final static int InputVisionDominance=6;
    public final static int InputScentDominance=7;
    public final static int InputNourishments=8;
    public final static int InputIsHungry=9;
    public final static int InputIsPregnant=10;
    public final static int InputMouthAtPoint=11;
